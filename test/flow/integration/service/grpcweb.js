...
import { SimpleService, SimpleServiceClient } from "../../../../examples/flow/generated/proto/examplecom/simple_service_pb_service";
import { StreamRequest, UnaryRequest } from "../../../../examples/flow/generated/proto/examplecom/simple_service_pb";
...
describe("service/grpc-web", () => {
  ...
  it("should generate valid javascript sources", () => {
    const generatedService = readFileSync(resolve(__dirname, "../../../../examples/flow/generated/proto/examplecom/simple_service_pb_service.js"), "utf8");
